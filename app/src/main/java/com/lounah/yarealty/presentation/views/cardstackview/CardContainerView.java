...
public class CardContainerView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        inflate(getContext(), com.yuyakaido.android.cardstackview.R.layout.card_frame, this);
        contentContainer = (ViewGroup) findViewById(com.yuyakaido.android.cardstackview.R.id.card_frame_content_container);
        overlayContainer = (ViewGroup) findViewById(com.yuyakaido.android.cardstackview.R.id.card_frame_overlay_container);
    }
    ...
    public void setContainerEventListener(CardContainerView.ContainerEventListener listener) {
