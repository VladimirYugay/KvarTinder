package com.lounah.yarealty.presentation.views.cardstackview;
...
public class CardStackView extends FrameLayout {
    ...
    private com.yuyakaido.android.cardstackview.CardStackView.CardEventListener cardEventListener = null;
    ...
    public CardStackView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.yuyakaido.android.cardstackview.R.styleable.CardStackView);
        setVisibleCount(array.getInt(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_visibleCount, option.visibleCount));
        setSwipeThreshold(array.getFloat(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_swipeThreshold, option.swipeThreshold));
        setTranslationDiff(array.getFloat(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_translationDiff, option.translationDiff));
        setScaleDiff(array.getFloat(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_scaleDiff, option.scaleDiff));
        setStackFrom(StackFrom.values()[array.getInt(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_stackFrom, option.stackFrom.ordinal())]);
        setElevationEnabled(array.getBoolean(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_elevationEnabled, option.isElevationEnabled));
        setSwipeEnabled(array.getBoolean(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_swipeEnabled, option.isSwipeEnabled));
        setSwipeDirection(SwipeDirection.from(array.getInt(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_swipeDirection, 0)));
        setLeftOverlay(array.getResourceId(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_leftOverlay, 0));
        setRightOverlay(array.getResourceId(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_rightOverlay, 0));
        setBottomOverlay(array.getResourceId(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_bottomOverlay, 0));
        setTopOverlay(array.getResourceId(com.yuyakaido.android.cardstackview.R.styleable.CardStackView_topOverlay, 0));
        array.recycle();
    }
    ...
    public void setCardEventListener(com.yuyakaido.android.cardstackview.CardStackView.CardEventListener listener) {
